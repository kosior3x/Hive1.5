...
class BioAgent:
    def __init__(self, agent_id, vector_size=5):
        ...
        # A1. Desynchronization Stats
        self.age = 0
        self.creation_time = time.time()
        # Individual decay rate (randomized around 0.05) to prevent global sync
        self.decay_rate = np.clip(np.random.normal(0.05, 0.01), 0.01, 0.1)
